...
class UserAdmin(BaseUserAdmin):
    ...
    fieldsets = BaseUserAdmin.fieldsets + (('Extra Info', {'fields': ('role', 'phone', 'avatar', 'is_email_verified')}),)

    add_fieldsets = BaseUserAdmin.add_fieldsets + (('Extra Info', {'fields': ('email', 'first_name', 'last_name', 'role', 'phone')}),)
